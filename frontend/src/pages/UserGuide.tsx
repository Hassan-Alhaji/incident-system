    ...
    ar: {
        ...
        list: [
          ...
          },
          {
            ...
            responsibilities: [
              ...
              'الاطلاع على لوحة التحليلات والإحصائيات العامة (Analytics) وتفعيل وضع شاشة العرض التنفيذية (Executive Wallboard) للعرض على الشاشات الكبيرة والتلفاز بدقة كاملة وبدون تمرير.'
            ]
          },
          {
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'كيف يتم إشعار مدراء وممثلي الأقسام عند إحالة حادث لقسمهم؟', a: 'يُرسل النظام إشعاراً بريدياً رسمياً عالي الأولوية عبر Microsoft Graph API من البريد الرسمي (hse-noreply@saudimotorsport.com) إلى مدير القسم وجميع ممثلي القسم المسجلين. يتضمن البريد رقم التذكرة، مستوى الخطورة، الموقع، وتفاصيل البلاغ مع زر مباشر لمراجعة التذكرة واتخاذ الإجراء المطلوب فوراً.' },
          { q: 'كيف يتم تعيين مدراء وممثلي الأقسام في النظام؟', a: 'من صفحة الإعدادات (Settings → Departments)، يمكن للأدمن اختيار مدير القسم وممثليه بسهولة عبر البحث الذكي بالإكمال التلقائي (Autocomplete) بكتابة اسم الموظف ليتم جلب اسمه وبريده ورقم جواله تلقائياً، أو إدخال البيانات يدوياً. وفور الحفظ، يستلم المسؤول بريداً رسمياً باللغة الإنجليزية يخطره بتعيينه في المنصة مع رابط تسجيل الدخول.' },
          ...
          { q: 'كيف أستخدم شاشة العرض التنفيذية (Wallboard) والتبديل بين المظهرين الأبيض والداكن؟', a: 'من صفحة الإحصائيات (Analytics)، اضغط زر (🖥️ تكبير الشاشة / Wallboard) لعرض لوحة القيادة التنفيذية الكاملة بجميع شارتاتها وتصنيفاتها دون إخفاء أي بيانات مع الخريطة التفاعلية على اليمين. يمكنك التبديل فوراً بين الوضع الأبيض والداكن عبر زر (☀️ / 🌙)، كما يمكنك النقر على أي أسطوانة مؤشرات (Vial) أو تصنيف خطورة أو إدارة لتصفية جدول التفاصيل فورياً (Zero-Lag Drilldown).' }
        ]
      }
    },
    en: {
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'How are Department Managers and Representatives notified of assigned incidents?', a: 'The system automatically dispatches an official high-priority email via Microsoft Graph API from the verified corporate sender (hse-noreply@saudimotorsport.com) to both the Department Manager and all active Department Representatives. The email details the Ticket ID, severity level, location, and description, complete with a direct-action button to access and manage the ticket in the platform.' },
          { q: 'How are Department Managers and Representatives appointed in the system?', a: 'Under Settings → Departments, administrators can select managers and representatives using the smart autocomplete search by typing any employee name or email. Contact details (name, email, phone) auto-populate instantly. Upon saving, an official English onboarding email is automatically delivered to the user with a direct portal link.' },
          ...
          { q: 'How to use the Executive Big-Screen Wallboard and switch themes?', a: 'From the Analytics page, click the Wallboard button (🖥️) to launch full-screen executive monitoring with all charts, categories, and the live interactive map situated on the right side. You can toggle instantly between Light Mode and Dark Mode via the sun/moon icon (☀️ / 🌙). Clicking any cylinder gauge (Vial), severity level, or department instantly filters the drilldown incident table in memory with zero latency.' }
        ]
      }
    }
  };
