...
const PublicVerify = () => {
 ...
 <div className="bg-green-50 text-green-700 p-4 rounded-xl shadow-sm flex items-center justify-center gap-3">
 <CheckCircle size={24} />
 <span className="font-bold">Verified Authentic Report</span>
 </div>

 <div className="divide-y divide-gray-100 text-left border rounded-xl shadow-sm overflow-hidden">
 <div className="p-3 flex justify-between bg-gray-50">
 <span className="text-gray-500 text-base">Ticket No</span>
 <span className="font-bold text-gray-900">{result.ticketNo}</span>
 </div>
 <div className="p-3 flex justify-between">
 <span className="text-gray-500 text-base">Type</span>
 <span className="font-medium text-gray-800">{result.type}</span>
 </div>
 <div className="p-3 flex justify-between bg-gray-50">
 <span className="text-gray-500 text-base">Status</span>
 <span className="text-base font-bold uppercase tracking-wider">{result.status}</span>
 </div>
 <div className="p-3 flex justify-between">
 <span className="text-gray-500 text-base">Reporter</span>
 ...
 <div className="bg-red-50 text-red-700 p-4 rounded-xl shadow-sm flex items-center justify-center gap-3">
 <XCircle size={24} />
