...
const IncidentWizard = () => {
 ...
 <span className={`text-base mt-2 font-medium ${active ? 'text-emerald-600' : 'text-gray-400'}`}>{step.title}</span>
 </div>
 );
 })}
 </div>
 ...
 <label className="block text-base font-medium text-gray-700 mb-1">Incident Type</label>
 <select 
 ...
 <div className="md:col-span-2">
 <label className="block text-base font-medium text-gray-700 mb-1">Date & Time</label>
 <input
 type="datetime-local"
 className="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-blue-400"
 ...
 <label className="block text-base font-medium text-gray-700 mb-2">Incident Location</label>
 <LocationPickerMap
 ...
 <div className="bg-emerald-50 border border-emerald-200 p-4 rounded-xl shadow-sm mb-6 text-base text-emerald-800">
 Please provide the event details and your post assignment.
 </div>
 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
 <div className="md:col-span-2">
 <label className="block text-base font-medium text-gray-700 mb-1">Event Name</label>
 <input
 type="text"
 className="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-blue-400"
 ...
 <div>
 <label className="block text-base font-medium text-gray-700 mb-1">Venue</label>
 <input
 type="text"
 className="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-blue-400"
 ...
 <div className="md:col-span-2">
 <label className="block text-base font-medium text-gray-700 mb-1">Post Number</label>
 <input
 type="text"
 className="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-blue-400"
 ...
 <div onClick={() => handleSelectType('SAFETY', 'INCIDENT')} className={`p-6 border-2 rounded-xl shadow-sm cursor-pointer hover:border-red-500 ${selectedType === 'SAFETY' ? 'border-red-500 bg-red-50' : 'border-gray-200'}`}>
 <h4 className="font-bold">Incident Report</h4>
 </div>
 <div onClick={() => handleSelectType('SPORT', 'PIT_GRID')} className={`p-6 border-2 rounded-xl shadow-sm cursor-pointer hover:border-emerald-500 ${selectedType === 'SPORT' ? 'border-emerald-500 bg-emerald-50' : 'border-gray-200'}`}>
 <h4 className="font-bold">Pit/Grid Report</h4>
 </div>
 {isMedicalRole && (
 <div onClick={() => handleSelectType('MEDICAL', 'MEDICAL')} className={`p-6 border-2 rounded-xl shadow-sm cursor-pointer hover:border-green-500 ${selectedType === 'MEDICAL' ? 'border-green-500 bg-green-50' : 'border-gray-200'}`}>
 ...
 <div>
 <label className="block text-base font-bold text-gray-500 uppercase">Driver's Name</label>
 ...
 <div>
 <label className="block text-base font-bold text-gray-500 uppercase">Date</label>
 <input type="date" className="w-full border p-2 rounded" value={formData.dateTime.slice(0, 10)} readOnly />
 </div>
 <div>
 <label className="block text-base font-bold text-gray-500 uppercase">POST #</label>
 ...
 <div>
 <label className="block text-base font-bold text-gray-500 uppercase mb-2">Role at Event</label>
 <div className="flex flex-wrap gap-2">
 {['DRIVER', 'CO_DRIVER', 'OFFICIAL', 'PIT_CREW', 'SPECTATOR', 'OTHER'].map(role => (
 <button
 key={role}
 className={`px-3 py-1 rounded-full text-base border ${medicalData.patientRole === role ? 'bg-emerald-600 text-white border-emerald-600' : 'bg-white text-gray-600 border-gray-300'}`}
 ...
 <div>
 <label className="block text-base font-bold text-gray-700">Where Seen</label>
 <input className="w-full border p-2 rounded" value={medicalData.whereSeen} onChange={e => updateMedical('whereSeen', e.target.value)} />
 </div>
 <div>
 <label className="block text-base font-bold text-gray-700">Condition on Initial Presentation</label>
 ...
 <div>
 <label className="block text-base font-bold text-gray-700">Treatment Performed</label>
 ...
 <div>
 <label className="block text-base font-bold text-gray-700 mb-2">Subsequent Treatment Recommended</label>
 <div className="grid grid-cols-2 gap-2">
 ...
 <section className="bg-emerald-50 p-4 rounded-xl shadow-sm">
 <h3 className="font-bold text-emerald-900 mb-2">7. Medical Personnel Information</h3>
 <div>
 <label className="block text-base font-bold text-emerald-700 uppercase">Name of Medical Personnel</label>
 ...
 <span className="px-3 py-1 bg-gray-100 rounded-full text-base font-bold text-gray-600">{eventCategory}</span>
 <span className="px-3 py-1 bg-emerald-100 text-emerald-700 rounded-full text-base font-bold">{subType.replace('_', ' ')}</span>
 </div>
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div>
 <label className="block text-base font-medium text-gray-700">Car Number (Concerned)</label>
 ...
 <div>
 <label className="block text-base font-medium text-gray-700">Time</label>
 ...
 <div>
 <label className="block text-base font-medium text-gray-700">Lap No.</label>
 <input className="w-full border p-2 rounded" value={formData.lapNumber} onChange={e => updateField('lapNumber', e.target.value)} />
 </div>
 <div>
 <label className="block text-base font-medium text-gray-700">Session</label>
 ...
 <div>
 <label className="block text-base font-medium text-gray-700">Event</label>
 ...
 <div className="md:col-span-2">
 <label className="block text-base font-medium text-gray-700 mb-1">Priority</label>
 ...
 {/* Pit/Grid Specifics */}
 {subType === 'PIT_GRID' && (
 <div className="space-y-6 bg-emerald-50 p-6 rounded-xl shadow-sm border border-emerald-100">
 <h3 className="font-bold text-emerald-900 border-b border-emerald-200 pb-2">Pit & Grid Details</h3>

 {/* 1) Pit Selection */}
 <div>
 <label className="block text-base font-medium text-emerald-900 mb-2">Pit In Use</label>
 <div className="flex gap-4">
 ...
 className="text-emerald-600 focus:ring-blue-400"
 />
 <span className="text-base font-medium text-gray-700">{pit}</span>
 </label>
 ))}
 </div>
 </div>
 ...
 <div>
 <label className="block text-base font-bold text-emerald-700 uppercase mb-1">Session</label>
 ...
 <div>
 <label className="block text-base font-bold text-emerald-700 uppercase mb-1">Vehicle No</label>
 ...
 <div>
 <label className="block text-base font-bold text-emerald-700 uppercase mb-1">Lap No</label>
 ...
 <div>
 <label className="block text-base font-bold text-emerald-700 uppercase mb-1">Team Name</label>
 ...
 <h4 className="text-base font-bold text-emerald-900 mb-3 block">Pit Lane Speed</h4>
 <div className="grid grid-cols-2 gap-4">
 <div>
 <label className="block text-base text-gray-500 mb-1">Speed Limit</label>
 ...
 <div>
 <label className="block text-base text-gray-500 mb-1">Recorded Speed</label>
 ...
 {/* 4) Radar Operator */}
 <div className="bg-white p-4 rounded-lg border border-emerald-200">
 <h4 className="text-base font-bold text-emerald-900 mb-3 block">Radar Operator</h4>
 <div className="grid grid-cols-2 gap-4">
 <div>
 <label className="block text-base text-gray-500 mb-1">Operator Name</label>
 ...
 <div>
 <label className="block text-base text-gray-500 mb-1">Operator Phone</label>
 ...
 {/* 5) Required Checks */}
 <div>
 <label className="block text-base font-medium text-emerald-900 mb-2">Violation Checks</label>
 <div className="space-y-2">
 {[
 ...
 />
 <span className="text-base text-gray-700">{check.label}</span>
 </label>
 ))}
 </div>
 </div>
 ...
 {/* 7) Remarks */}
 <div>
 <label className="block text-base font-medium text-emerald-900 mb-1">Remarks / Recommendations</label>
 ...
 {eventCategory === 'OTHER' && (
 <div className="bg-gray-50 p-4 rounded-xl shadow-sm border border-gray-200 mt-6">
 ...
 <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 shadow-sm relative overflow-hidden">
 ...
 <div className="md:col-span-2">
 <label className="block text-base font-medium text-gray-700 mb-2">Affiliate</label>
 <div className="flex gap-4">
 ...
 <>
 <div>
 <label className="block text-base font-medium text-gray-700">Department</label>
 ...
 <div>
 <label className="block text-base font-medium text-gray-700">Employee/GOSI ID</label>
 ...
 <div>
 <label className="block text-base font-medium text-gray-700">GOSI Report Date</label>
 ...
 <label htmlFor="file-upload" className="bg-emerald-600 text-white px-6 py-3 rounded-xl shadow-sm font-bold cursor-pointer hover:bg-emerald-700 transition">Browse Files</label>
 {files.length > 0 && <div className="mt-8 text-base text-gray-600">{files.length} files selected</div>}
 </div>
 {subType === 'MEDICAL' && <p className="mt-4 text-base text-gray-500">Section 8: Upload photos/files related to the incident</p>}
 </div>
 )
 }
 ...
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Patient Name</span> <div className="font-medium text-gray-900">{medicalData.patientGivenName} {medicalData.patientSurname}</div></div>
 <div><span className="text-gray-500 text-base uppercase tracking-wider">DOB / Gender</span> <div className="font-medium text-gray-900">{medicalData.patientDob} ({medicalData.patientGender})</div></div>
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Role</span> <div className="font-medium text-gray-900">{medicalData.patientRole?.replace('_', ' ')}</div></div>
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Competitor No</span> <div className="font-medium text-gray-900">{medicalData.patientCarNo || '-'}</div></div>
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Motorsport ID</span> <div className="font-medium text-gray-900">{medicalData.motorsportId || '-'}</div></div>
 <div><span className="text-gray-500 text-base uppercase tracking-wider">License Action</span> <div className={`font-bold ${medicalData.licenseAction === 'SUSPENDED' ? 'text-red-600' : 'text-green-600'}`}>{medicalData.licenseAction?.replace('_', ' ')}</div></div>
 </div>
 </div>
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 text-base">
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Event</span> <div className="font-medium text-gray-900">{formData.eventName}</div></div>
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Venue</span> <div className="font-medium text-gray-900">{formData.venue}</div></div>
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Permit No</span> <div className="font-medium text-gray-900">{medicalData.permitNumber}</div></div>
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Time of Incident</span> <div className="font-medium text-gray-900">{medicalData.incidentTime}</div></div>
 </div>
 </div>
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Injury Type</span> <div className="font-medium text-gray-900">{medicalData.injuryType?.replace(/_/g, ' ')}</div></div>
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Arrival Method</span> <div className="font-medium text-gray-900">{medicalData.arrivalMethod?.replace(/_/g, ' ')}</div></div>
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Treatment Loc</span> <div className="font-medium text-gray-900">{medicalData.treatmentLocation?.replace(/_/g, ' ')} {medicalData.treatmentLocationDetail ? `(${medicalData.treatmentLocationDetail})` : ''}</div></div>
 </div>

 {medicalData.incidentDescription && (
 <div>
 <span className="text-gray-500 text-base uppercase tracking-wider block mb-1">Description of Circumstances</span>
 ...
 <div>
 <span className="text-gray-500 text-base uppercase tracking-wider block mb-1">Initial Condition</span>
 <div className="bg-gray-50 p-3 rounded text-gray-800 italic">{medicalData.initialCondition}</div>
 </div>
 )}
 {medicalData.treatmentGiven && (
 <div>
 <span className="text-gray-500 text-base uppercase tracking-wider block mb-1">Treatment Performed</span>
 ...
 <div className="grid grid-cols-2 gap-4 text-base">
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Incident Type</span> <div className="font-bold text-gray-900">{offCircuitData.incidentType}</div></div>
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Date & Time</span> <div className="font-medium text-gray-900">{formData.dateTime.replace('T', ' ')}</div></div>
 <div><span className="text-gray-500 text-base uppercase tracking-wider">GPS / Location</span> <div className="font-medium text-gray-900 truncate"><a href={formData.location} target="_blank" className="text-blue-500 hover:underline">{formData.location}</a></div></div>
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Injured Person</span> <div className="font-bold text-gray-900">{offCircuitData.injuredName || 'None'}</div></div>
 </div>
 <div className="mt-4">
 <span className="text-gray-500 text-base uppercase tracking-wider block mb-1">Description</span>
 ...
 <div className="grid grid-cols-2 gap-4 text-base">
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Type</span> <div className="font-bold text-gray-900">{selectedType}</div></div>
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Sub-Type</span> <div className="font-bold text-gray-900">{subType.replace('_', ' ')}</div></div>
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Category</span> <div className="font-medium text-gray-900">{eventCategory}</div></div>
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Priority</span> <div className="font-medium text-gray-900">{formData.priority}</div></div>
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Location</span> <div className="font-medium text-gray-900">{formData.location}</div></div>
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Post Number</span> <div className="font-medium text-gray-900">{formData.postNumber || 'N/A'}</div></div>
 </div>

 {subType === 'PIT_GRID' && (
 <div className="mt-4 pt-4 border-t space-y-4">
 <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Pit</span> <div className="font-bold">{formData.pitNumber || '-'}</div></div>
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Session</span> <div className="font-bold">{formData.sessionCategory}</div></div>
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Car #</span> <div className="font-bold">{formData.carNumber}</div></div>
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Lap</span> <div className="font-bold">{formData.lapNumber || '-'}</div></div>
 </div>

 {(formData.speedRecorded || formData.speedLimit) && (
 <div className="bg-gray-50 p-3 rounded flex gap-6 border border-gray-100">
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Speed Limit</span> <div className="font-medium">{formData.speedLimit || 'N/A'}</div></div>
 <div><span className="text-gray-500 text-base uppercase tracking-wider">Recorded</span> <div className="font-bold text-red-600">{formData.speedRecorded || 'N/A'}</div></div>
 </div>
 )}

 <div>
 <span className="text-gray-500 text-base uppercase tracking-wider block mb-2">Violations / Checks</span>
 <div className="flex flex-wrap gap-2">
 {formData.drivingOnWhiteLine && <span className="px-2 py-1 bg-red-100 text-red-700 text-base font-bold rounded">White Line</span>}
 {formData.refueling && <span className="px-2 py-1 bg-red-100 text-red-700 text-base font-bold rounded">Refueling</span>}
 {formData.driverChange && <span className="px-2 py-1 bg-red-100 text-red-700 text-base font-bold rounded">Driver Change</span>}
 {formData.excessMechanics && <span className="px-2 py-1 bg-red-100 text-red-700 text-base font-bold rounded">Excess Mechanics</span>}
 {(!formData.drivingOnWhiteLine && !formData.refueling && !formData.driverChange && !formData.excessMechanics) && (
 <span className="text-gray-400 text-base italic">No specific violations checked</span>
 )}
 </div>
 </div>
 ...
 {formData.pitRemarks && (
 <div>
 <span className="text-gray-500 text-base uppercase tracking-wider block mb-1">Remarks</span>
 ...
 <div className="space-y-2">
 {formData.witnesses.map((w: any, i: number) => (
 <div key={i} className="flex justify-between items-center text-base bg-gray-50 p-2 rounded">
 ...
 {/* --- EVIDENCE SUMMARY --- */}
 <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 shadow-sm flex items-center justify-between">
 ...
 <p className="text-base text-gray-500">Photos and videos uploaded</p>
 </div>
 </div>
 <span className="bg-gray-900 text-gray-800 px-4 py-2 rounded-full text-base font-bold">
 {files.length} {files.length === 1 ? 'File' : 'Files'}
 </span>
 </div>

 {/* --- SYSTEM AUTO FIELDS (Section 9) --- */}
 <div className="bg-gray-100 p-6 rounded-xl shadow-sm border border-gray-300">
 <h4 className="font-bold text-gray-700 mb-4 uppercase text-base">9. System-Auto Fields</h4>
 <div className="grid grid-cols-2 gap-4 text-base text-gray-600">
 <div><label className="block text-gray-400 text-base">Marshal ID</label> {user?.marshalId || 'Auto (Backend)'}</div>
 <div><label className="block text-gray-400 text-base">Marshal Name</label> {user?.name}</div>
 <div><label className="block text-gray-400 text-base">Marshal Email</label> {user?.email}</div>
 <div><label className="block text-gray-400 text-base">Marshal Mobile</label> {user?.mobile || 'Auto (Backend)'}</div>
 <div><label className="block text-gray-400 text-base">Date</label> {new Date().toLocaleDateString('en-US')}</div>
 </div>
 </div>
 </div>
 )
 ...
 <button onClick={handleBack} disabled={currentStep === 0 || isSubmitting} className="px-8 py-3 rounded-xl shadow-sm border border-gray-200 font-bold text-gray-600 hover:bg-gray-50 disabled:opacity-50 flex items-center gap-2"><ArrowLeft size={18} /> Back</button>
 {activeSteps[currentStep].id !== 'type' && (
 <button onClick={handleNext} disabled={isSubmitting || !isStepValid()} className="px-8 py-3 rounded-xl shadow-sm bg-emerald-600 text-white font-bold hover:bg-emerald-700 disabled:bg-gray-300 disabled:cursor-not-allowed shadow-lg shadow-emerald-200 transition-all flex items-center gap-2">
