...
const UserProfile = () => {
 ...
 <div className="bg-emerald-700 p-6 text-gray-800 flex items-center gap-4">
 ...
 {/* Read Only Section */}
 <div className="grid grid-cols-1 md:grid-cols-3 gap-6 bg-gray-50 p-4 rounded-xl shadow-sm border border-gray-100">
 <div>
 <label className="block text-base font-bold text-gray-500 uppercase mb-1 flex items-center gap-1">
 <Hash size={12} /> ID
 </label>
 ...
 />
 <p className="text-base text-gray-400 mt-1">English characters only</p>
 </div>
 ...
 type="submit"
 disabled={isSaving}
 className="w-full bg-emerald-600 text-white rounded-xl shadow-sm py-3 font-bold hover:bg-emerald-700 transition-colors shadow-lg shadow-emerald-200 flex items-center justify-center gap-2 disabled:opacity-50"
 >
 <Save size={18} />
