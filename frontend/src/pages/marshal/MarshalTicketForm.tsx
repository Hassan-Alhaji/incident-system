                    ...
                    <div className="space-y-8 max-w-3xl mx-auto">
                        ...
                        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label className="block text-xs font-bold text-gray-500 uppercase">Post Number</label>
                        ...
                        {selectedType && (
                            <div className="mt-8 p-4 bg-gray-50 rounded-lg border border-gray-200">
                                <h3 className="font-bold text-sm text-gray-700 mb-2">Current Event Confirmation</h3>
                    ...
                    <div className="space-y-6 max-w-3xl mx-auto">
                        ...
                        {subType === 'PIT_GRID' && (
                            <div className="bg-emerald-50 p-4 rounded-xl border border-emerald-100 grid grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-sm font-medium text-emerald-900 mb-1">Car Number</label>
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-emerald-900 mb-1">Session</label>
