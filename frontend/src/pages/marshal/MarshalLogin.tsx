...
const MarshalLogin = () => {
 ...
 {error && (
 <div className="mb-4 bg-red-50 text-red-700 p-3 rounded-md text-base">
 {error}
 </div>
 )}
 ...
 type="submit"
 disabled={loading}
 className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-base font-medium text-gray-800 bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
 >
 ...
 <div className="text-center mb-4 text-base text-gray-500">
 ...
 type="button"
 onClick={() => setStep(1)}
 className="w-full text-center text-base text-gray-600 hover:text-gray-900"
 >
 Back
 </button>
 </form>
