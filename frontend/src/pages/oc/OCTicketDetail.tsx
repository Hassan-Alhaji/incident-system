...
const OCTicketDetail = () => {
    ...
    useEffect(() => { 
        fetchTicket(); 
        api.get('/oc/users').then(res => setRouteUsers(res.data.users || res.data)).catch(console.error);
    ...
    const handleControllerAction = async (actionParam: string) => {
        ...
        try {
            ...
            await api.put(`/oc/tickets/${ticket.id}/hse-action`, {
                action: actionParam,
    ...
    const handleDepRepAction = async () => {
        ...
        setError('');
        try {
            await api.put(`/oc/tickets/${id}/dep-rep`, {
    ...
    const handleDepManagerApprove = async () => {
        ...
        setError('');
        try {
            await api.put(`/oc/tickets/${id}/dep-manager-approve`, {});
            await fetchTicket();
        } catch (err: any) {
