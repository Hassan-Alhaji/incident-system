...
const MedicalSubmission: React.FC = () => {
 ...
 <div>
 <label className="block text-base font-medium text-gray-700">Incident Time (Approx)</label>
 ...
 <div>
 <label className="block text-base font-medium text-gray-700">Consciousness</label>
 ...
 type="submit"
 disabled={loading}
 className="mt-6 w-full bg-red-600 text-gray-800 py-3 rounded-lg font-bold text-lg hover:bg-red-700 transition"
 >
