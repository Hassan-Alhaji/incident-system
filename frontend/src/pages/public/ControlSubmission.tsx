...
const ControlSubmission: React.FC = () => {
 ...
 <div>
 <label className="block text-base font-medium text-gray-700">Car / Bike #</label>
 ...
 <div>
 <label className="block text-base font-medium text-gray-700">Lap #</label>
 <input type="number" value={lapNumber} onChange={e => setLapNumber(e.target.value)} className="w-full p-2 border rounded" />
 </div>
 </div>

 <div>
 <label className="block text-base font-medium text-gray-700">Violation Type</label>
 ...
 type="submit"
 disabled={loading}
 className="mt-6 w-full bg-blue-900 text-gray-800 py-3 rounded-lg font-bold text-lg hover:bg-blue-800 transition"
 >
