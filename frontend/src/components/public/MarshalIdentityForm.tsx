...
const MarshalIdentityForm: React.FC<MarshalIdentityProps> = ({
 ...
 <div>
 <label className="block text-base font-medium text-gray-700 mb-1">Marshal ID *</label>
 <input
 type="text"
 required
 value={marshalId}
 ...
 <div>
 <label className="block text-base font-medium text-gray-700 mb-1">Mobile *</label>
 <input
 type="tel"
 required
 value={mobile}
 ...
 <div>
 <label className="block text-base font-medium text-gray-700 mb-1">Post / Location # *</label>
 <input
 type="number"
 step="0.1"
 required
